...
function Dashboard() {
  ...
  // Processar os dados para o grafico de eventos por organizador
  ...
  // Processar os dados para o grafico de pizza de aniversario dos usuarios
  ...
  return (
    <div style={{ padding: 20 }}>
      <h2>Dashboard</h2>
      <div style={{ width: "500px", marginBottom: 40 }}>
        <Bar data={barData} />
      </div>
      <div style={{ width: "200px" }}>
        <h3>Usuários por mês de aniversário</h3>
        <Pie data={pieData} />
      </div>
    </div>
  );
